...
import 'package:weight_tracker_app/pages/home/home_view_model.dart';
...
import '../../utils/ui/appBar/custom_app_bar.dart';
import '../../utils/ui/button/custom_delete_btn.dart';
import '../../utils/ui/button/custom_floating_btn.dart';
import '../../utils/ui/card/data_card.dart';
...
class _HomeViewState extends HomeViewModel
    with ProjectColors, ProjectIcons, ProjectRadius {
  @override
          ...
          floatingActionButton: isFloatingActive
              ? (!isFloatingDelete
                  ...
                  : FloatingButtonDelete(
                      onPressed: isFloatingActiveOnDelete
                          ? () =>
                              listViewKey.currentState?.deleteSelectedItems()
                          : null))
              : null,
