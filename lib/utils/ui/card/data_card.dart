          ...
          child: Column(children: [
            Padding(
                ...
                child: _DataRow(children: [
                  _CardWeightColumn(
                      findString(languageIndex, LanguagesEnum.current),
                      currentData),
                  _CardWeightColumn(
                      findString(languageIndex, LanguagesEnum.change),
                      changeData),
                ])),
            Padding(
                ...
                child: _DataRow(children: [
                  _CardWeightColumn(
                      findString(languageIndex, LanguagesEnum.weekly),
                      weeklyData),
                  _CardWeightColumn(
                      findString(languageIndex, LanguagesEnum.monthly),
                      monthlyData),
                ])),
          ])),
    );
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Column(children: [
        ...
        CustomTitleText(
            text: weightData == null
                ? '-'
                : '${weightData!.toStringAsFixed(1)}kg')
      ]),
    );
  }
}
