        ...
        children: [
          Padding(
              ...
              child: CustomTitleText(
                  text: findString(
                      widget.languageIndex ?? 0, LanguagesEnum.addRecord))),
          Padding(
            padding:
                ...
                children: [
                  Expanded(
                      ...
                      child: CustomElevatedButton(
                          ...
                          text: findString(widget.languageIndex ?? 0,
                              LanguagesEnum.cancelUpper))),
                  const Spacer(),
                  Expanded(
                      flex: 3,
                      child: CustomElevatedButton(
                          ...
                          text: widget.isOkBtnActive
                              ? findString(widget.languageIndex ?? 0,
                                  LanguagesEnum.okUpper)
                              : findString(widget.languageIndex ?? 0,
                                  LanguagesEnum.disable))),
                ]),
          )
        ]);
  }
