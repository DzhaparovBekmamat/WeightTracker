...
class ProjectPaddings {
  final EdgeInsets paddingHorizontalNormal =
      const EdgeInsets.symmetric(horizontal: 10);
  final EdgeInsets paddingHorizontalVeryHigh =
      const EdgeInsets.symmetric(horizontal: 50);
  final EdgeInsets paddingVerticalNormal =
      const EdgeInsets.symmetric(vertical: 10);
  final EdgeInsets paddingVerticalMed =
